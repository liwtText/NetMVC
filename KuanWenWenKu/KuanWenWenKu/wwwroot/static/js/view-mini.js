...
(function () {
    ...
    Viewer._ChangeSwfScreen = function () {
        ...
        $("div .inner_page div img").css({
            left: ((_PageHeight2_1 - 800) / 2) + "px"
        });
    ...
    Viewer._AddAdInfo2 = function (_OOl0lO, _1lOOOO, _pageindex, _PageHeight2_2, adindex) {
        ...
        _Olll1O += '<iframe style="padding-top:0px;" id="ad_iframe_' + _pageindex + '" width="918px" src="ad.aspx?id=' + _OOl0lO + '" height="120" frameborder="0" scrolling="no"></iframe>';
        _Olll1O += '</div>';
        return _Olll1O;
    };
    Viewer._AddAdInfo = function (_OOl0lO, _1lOOOO, _pageindex, _PageHeight2_2, adindex) {
        ...
        var pl = parseInt((920 - parseInt(arrAd[1]))/2);

        var _Olll1O = '<div class="addiv" style="float:auto;text-align:center; padding:10px 0px;overflow:hidden;padding-left:'+pl+'px"';
        if (arrAd[1] == "920")
    ...
    Viewer._LoadSwfpage = function (_pageindex, type) {
        ...
        if (_OO1Ol0 && _OO1Ol0.length < 1) {
            ...
            if (Viewer._lmt >= _pageindex) {
                ...
                if (title=="")
                    _1OlOll.innerHTML = "<img src='" + imgurl + "' alt='' style='left:" + ((_swfwidth - 800) / 2) + "px' ondragstart='return false;'/>";
                else
                    _1OlOll.innerHTML = "<img src='" + imgurl + "' alt='" + (title + "_第" + _pageindex + "页") + "' style='left:" + ((_swfwidth - 800) / 2) + "px' ondragstart='return false;'/>";
            }
            else {
